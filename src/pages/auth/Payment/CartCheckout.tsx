                                ...
                                <Box sx={{ ml: 96 }}>
                                    <Grid container spacing={2} sx={{ mt: 1, borderBottom: '1px solid #cccccc' }}>
                                        <Grid item xs={12}>
                                            <Grid container spacing={2} sx={{ borderBottom: '1px solid #cccccc' }}>
                                                ...
                                                <Grid item xs={12} sm={2} sx={{ fontSize: '16px', color: 'black', fontWeight: 600, p: 3 , ml : 16 }}>
                                                    $12
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                    ...
                                    <Grid container spacing={2} sx={{ mt: 1, borderBottom: '1px solid #cccccc' }}>
                                        <Grid item xs={12}>
                                            <Grid container spacing={2} sx={{ borderBottom: '1px solid #cccccc' }}>
                                                {/* <Grid item xs={8}></Grid> */}
                                                <Grid item xs={12} sm={6} sx={{ fontSize: '16px', fontWeight : 'bold', color: 'black', p: 3  , ml : -1.5}}>
                                                    Total due
                                                </Grid>
