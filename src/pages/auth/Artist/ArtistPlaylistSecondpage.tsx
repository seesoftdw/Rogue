...
const ArtistPlaylistSecondpage = (props: Props) => {
    ...
    return (
        <Box>
            <MainWrapper>
                ...
                <Box sx={{ borderBottom: '1px solid #cccccc' }}></Box>
                <Typography sx={{ fontSize: '18px', fontWeight: 'bold ', color: 'rgba(10, 32, 46, 0.9)', pt: 2, pb: 2 }}>Search for tracks</Typography>
                {/* <TextField size='small' sx={{ mb: 10, width: '451px', background: 'rgba(10, 32, 46, 0.05)' }}><FaSearch style={{ color: 'black ' }} /></TextField> */}
                <TextField
                    size='small'
                    sx={{ mb: 10, width: '451px', background: 'rgba(10, 32, 46, 0.05)' }}
                    InputProps={{
                        startAdornment: (
                ...
                <Link to = '/artistplaylisticon'>
                    <Button sx={{ ml: 60, background: ' linear-gradient(-180deg, rgb(0, 202, 255) 0%, rgb(0, 154, 255) 100%)', color: 'white', fontWeight: 'bold' }}>NEXT</Button>
                </Link>
...
export default ArtistPlaylistSecondpage;
