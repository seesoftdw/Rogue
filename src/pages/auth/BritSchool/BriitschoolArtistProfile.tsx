...
const BritschoolArtistProfile: React.FC = () => {
    return (
        <>
            <MainWrapper>
                <Box className="bsArtistProfile">
                    <Typography className='bsArtistHeader' >Artists</Typography>
                    <Box>
                        <CustomBreadcrumbs />
                    </Box>
                    <Box padding={0} margin={0} mt={3} sx={{ height: '240px', mb: 11 }} className="main-box">
