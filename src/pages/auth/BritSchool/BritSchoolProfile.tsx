import { Box, Divider, List, ListItem, ListItemIcon, ListItemText, Tab, Tabs, Typography, Grid, createTheme, ThemeProvider } from '@mui/material';
...
import ArtistsPlaylist from '../Artist/ArtistsPlaylist';
...
const BritSchoolProfile = (props: Props) => {
                        ...
                        <Box sx = {{mt : 18.6}}>
                            <ThemeProvider theme={theme}>
                                <Tabs value={tabValue} onChange={handleChange} sx={{
                                    ...
                                    <Tab className='artistsProfileTab' style={tabValue === 0 ? activeTabStyle : tabStyle} label="ARTIST" />
                                    <Tab className='artistsProfileTab' style={tabValue === 1 ? activeTabStyle : tabStyle} label="RELEASES" />
                                    <Tab className='artistsProfileTab' style={tabValue === 2 ? activeTabStyle : tabStyle} label="PLAYLISTS" />
                                </Tabs>
                            </ThemeProvider>
                        </Box>
                        <Box p={1} color={'grey'} mt={'10px'} sx = {{mt : 19}}>
...
export default BritSchoolProfile
