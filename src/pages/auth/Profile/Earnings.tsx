                    ...
                    <Box sx={{ pt: 3 }}>
                        <Grid container display={'flex'}>
                            <Grid item xs={5}>
                                ...
                                <Typography className='earnings-data' sx={{ pl: 2 }}>$2,500</Typography>
                            </Grid>
                            ...
                            <Grid item xs={6}>
                                <Grid container display={'flex'} sx={{ justifyContent: "space-between" }}>
                                    <Grid item xs={6}>
                                        ...
                                        <Typography className='earnings-data' sx={{ pl: 2 }}>$1,500</Typography>
                                    </Grid>
                        ...
                        <Typography className='donations-raised' sx={{ color: 'black', fontSize: '28px', pl: 2, fontWeight: 'bold' }}>$35.82</Typography>
