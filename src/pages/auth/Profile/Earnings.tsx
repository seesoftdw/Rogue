...
const Earnings: React.FC<Props> = (props) => {
                ...
                {tabValue === 0 && (
                    <Box sx={{ pt: 3 }}>
                        ...
                        <Grid container sx={{ pt: 0 }}>
                            ...
                            <Grid item xs={4}>
                                <Typography sx={{ color: 'black', fontSize: '36px', fontWeight: 'bold', pl: 2 }}>$681.6815</Typography>
                            </Grid>
                            ...
                            <Grid item xs={4}>
                                <Grid container>
                                    <Grid item xs={7}>
                                        <Typography sx={{ color: 'black', fontSize: '36px', fontWeight: 'bold', pl: 2 }}>$1,363.363</Typography>
                                    </Grid>
                                    <Grid item xs={4}>
                        ...
                        <Typography sx={{ color: 'black', fontSize: '18px', fontWeight: 'bold', pl: 2 ,pt: 2 , pb : 2 }}>Sales</Typography>

                        <Typography sx={{ color: 'rgba(10, 32, 46, 0.4)', fontSize: '14px', pl: 2 ,pt: 2 , }}>Tracks</Typography>
                        <Typography sx={{ color: 'black', fontSize: '28px', pl: 2  ,  fontWeight: 'bold'}}>$35.82</Typography>
