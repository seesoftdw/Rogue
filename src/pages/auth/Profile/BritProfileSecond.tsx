        ...
        <Box>
            <MainWrapper>
                <Box>
                    ...
                    <Typography sx={{ color: 'rgb(10, 32, 46)', fontSize: '18px', fontWeight: 'bold', mt: 5, pl: 2, pb: 2 }}>Donations from sales</Typography>
                    <Grid item xs={12} sx={{ ml: 2 }}>
                        <Grid container>
                            <Grid item xs={6.1}>
                                <Typography sx={{ color: 'rgb(10, 32, 46)', fontSize: '28px', fontWeight: 900, mt: 1 }}>$2,640</Typography>
                            </Grid>
